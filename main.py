...
class Bridger:
    def __init__(self, privatekey,chain,to,delay,api,mode=1):
        ...
        self.GleamAddress = Web3.to_checksum_address('0x8C531f965C05Fab8135d951e2aD0ad75CF3405A2')
